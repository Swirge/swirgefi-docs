...
* Lottery Ticket Fee for 1 ticket: 1 SWFI 
...
3 AM  - 2 PM \(UTC\)  - **20,000 SWFI tokens are injected into this lottery draw**
...
* Users will receive a ticket \(comprised of 4 digits\) for each 1 SWFI paid.
...
* The 2nd lottery number will be determined based on the %10 remainder of a hash encoded by the blockhash and the total pooled SWFI balance at the entry deadline.
